...
void GLWidget::change_current_chunk(Direction dir)
{
	...
	m_nchunk = m_map->getChunkAt(m_current_xchunk, m_current_zchunk-1);
	m_nwchunk = m_map->getChunkAt(m_current_xchunk-1, m_current_zchunk-1);
	m_wchunk = m_map->getChunkAt(m_current_xchunk-1, m_current_zchunk);
	m_swchunk = m_map->getChunkAt(m_current_xchunk-1, m_current_zchunk+1);
	m_schunk = m_map->getChunkAt(m_current_xchunk, m_current_zchunk+1);
	m_sechunk = m_map->getChunkAt(m_current_xchunk+1, m_current_zchunk+1);
	m_echunk = m_map->getChunkAt(m_current_xchunk+1, m_current_zchunk);
	m_nechunk = m_map->getChunkAt(m_current_xchunk+1, m_current_zchunk-1);
	m_centerchunk = m_map->getChunkAt(m_current_xchunk, m_current_zchunk);
