...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Wed Dec 7 17:16:48 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/terrain_gen1.0.0/ && $(COPY_FILE) --parents src/BloomShader.h src/Camera3d.h src/Chunk.h src/CSCIx229.h src/Generator.h src/Global.h src/GLWidget.h src/Heightmap.h src/MainWindow.h src/Map.h src/Object.h src/ObjectManager.h src/Particle.h src/ParticleEngine.h src/Perlin.h src/PlainShader.h src/Polygon.h src/Shapes.h src/Skybox.h src/TerrainTexture.h src/ToonShader.h src/TriangleMesh.h src/Vec3.h obj/terrain_gen1.0.0/ && $(COPY_FILE) --parents src/BloomShader.cpp src/Camera3d.cpp src/Chunk.cpp src/CSCIx229.cpp src/Generator.cpp src/GLWidget.cpp src/Heightmap.cpp src/main.cpp src/MainWindow.cpp src/Map.cpp src/Object.cpp src/ObjectManager.cpp src/Particle.cpp src/ParticleEngine.cpp src/Perlin.cpp src/PlainShader.cpp src/Polygon.cpp src/Shapes.cpp src/Skybox.cpp src/TerrainTexture.cpp src/ToonShader.cpp src/TriangleMesh.cpp src/Vec3.cpp obj/terrain_gen1.0.0/ && (cd `dirname obj/terrain_gen1.0.0` && $(TAR) terrain_gen1.0.0.tar terrain_gen1.0.0 && $(COMPRESS) terrain_gen1.0.0.tar) && $(MOVE) `dirname obj/terrain_gen1.0.0`/terrain_gen1.0.0.tar.gz . && $(DEL_FILE) -r obj/terrain_gen1.0.0
...
obj/PlainShader.o: src/PlainShader.cpp src/PlainShader.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/PlainShader.o src/PlainShader.cpp

obj/Polygon.o: src/Polygon.cpp src/Polygon.h \
		src/Vec3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Polygon.o src/Polygon.cpp

obj/Shapes.o: src/Shapes.cpp src/Shapes.h
