...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Thu Oct 20 22:19:20 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/terrain_gen1.0.0/ && $(COPY_FILE) --parents src/Camera3d.h src/Generator.h src/GLWidget.h src/Heightmap.h src/MainWindow.h src/Perlin.h src/Polygon.h src/Skybox.h src/TerrainTexture.h src/TriangleMesh.h src/Vec3.h obj/terrain_gen1.0.0/ && $(COPY_FILE) --parents src/Camera3d.cpp src/Generator.cpp src/GLWidget.cpp src/Heightmap.cpp src/main.cpp src/MainWindow.cpp src/Perlin.cpp src/Polygon.cpp src/Skybox.cpp src/TerrainTexture.cpp src/TriangleMesh.cpp src/Vec3.cpp obj/terrain_gen1.0.0/ && (cd `dirname obj/terrain_gen1.0.0` && $(TAR) terrain_gen1.0.0.tar terrain_gen1.0.0 && $(COMPRESS) terrain_gen1.0.0.tar) && $(MOVE) `dirname obj/terrain_gen1.0.0`/terrain_gen1.0.0.tar.gz . && $(DEL_FILE) -r obj/terrain_gen1.0.0
